...
# Generated by GNU Autoconf 2.69 for es40 0.18+.
#
# Report bugs to <iamcamiel@gmail.com>.
#
#
...
$0: iamcamiel@gmail.com about your system, including any
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures es40 0.18+ to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/es40]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of es40 0.18+:";;
   esac
  cat <<\_ACEOF
...
$as_echo "$as_me: WARNING: $2: proceeding with the compiler's result" >&2;}
( $as_echo "## ---------------------------------- ##
## Report this to iamcamiel@gmail.com ##
## ---------------------------------- ##"
...
It was created by es40 $as_me 0.18+, which was
...
rm -f core conftest.err conftest.$ac_objext \
  ...
  for i in /usr/ng/lib /usr/lib /usr/local/lib /opt/local/lib; do
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for pcap library in $i" >&5
$as_echo_n "checking for pcap library in $i... " >&6; }

  saved_LIBS=$LIBS
  LIBS="$saved_LIBS -L$i -lpcap"
  cat confdefs.h - <<_ACEOF >conftest.$ac_ext
/* end confdefs.h.  */
...
$as_echo "found" >&6; }
      ...
      { $as_echo "$as_me:${as_lineno-$LINENO}: result: not here" >&5
$as_echo "not here" >&6; }
    fi
  done


  for i in /usr/ng/include /usr/include /usr/local/include /opt/local/include; do
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for pcap header in $i" >&5
$as_echo_n "checking for pcap header in $i... " >&6; }
...
$as_echo "not here" >&6; }
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking whether pcap is available" >&5
$as_echo_n "checking whether pcap is available... " >&6; }
...
$as_echo "couldn't find any!" >&6; }
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking whether to use X11" >&5
$as_echo_n "checking whether to use X11... " >&6; }
...
ac_config_files="$ac_config_files Makefile doc/Makefile m4/Makefile src/Makefile"
...
ac_log="
This file was extended by es40 $as_me 0.18+, which was
generated by GNU Autoconf 2.69.  Invocation command line was
