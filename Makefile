...
################################################################################
#
# $Id: Makefile.am,v 1.2 2008/05/31 15:47:05 iamcamiel Exp $
#
# X-1.2      Camiel Vanderhoeven                      31-MAY-2008
#      Add parts of Poco.
#
...
CXXFLAGS = -Ofast -flto  -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -DHAVE_SDL -I/usr/include -DHAVE_PCAP  -DHAVE_X11 -pthread
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
X11_LIBS = -lX11
XMKMF = 
abs_builddir = /home/mv/Projekte/es40/src
abs_srcdir = /home/mv/Projekte/es40/src
